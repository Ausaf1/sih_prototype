    ...
    <div>
      ...
      <div className="container">
        ...
        <p className="content">
          ...
          effective disposal of Scholarships applications.Through
          our portal, we envision an ecosystem which ensures hassle free delivery
          of scholarship funds to the verified benificiary's bank accounts
        </p>
        <h4 className="head4">Mission</h4>
        <p className="content">
          Our aims is to provide common electronic portal for implementing
          Scholarships schemes launched by Union Government, State Government
